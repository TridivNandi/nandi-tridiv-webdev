...
module.exports = function (app, models) {
    ...
    app.post('/rmm/user/:uid/movie/:mid', addReview);
    app.get('/rmm/movie/:mid/reviews', findAllReviewsForMovieId);
    app.get('/rmm/user/:uid/reviews', findAllReviewsForUserId);
    app.put('/rmm/review/:rid', updateReview);
    app.delete('/rmm/review/:rid', deleteReview);
